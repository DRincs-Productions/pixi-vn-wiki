...
icon: /react.svg
title: React UI
description: Как интегрировать Pixi’VN с React, включая настройку, шаблоны и лучшие UI-библиотеки. Создание визуальных новелл или 2D-игр с React.
---
...
Подробнее о React можно узнать на [React website](https://react.dev/).

## Как добавить Pixi’VN в React-приложение

<Callout title="React template" type="info">

Доступны шаблоны Pixi’VN, использующие React. Подробнее о них можно прочитать в разделе <DynamicLink href="/start#project-initialization">templates</DynamicLink>.

Если вы хотите добавить Pixi’VN в существующее React-приложение, следуйте шагам ниже.

</Callout>

Сначала вам понадобится React-приложение и необходимо <DynamicLink href="/start#installation">установить pixi-vn</DynamicLink>. Для создания нового React-приложения рекомендуется использовать [Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project).
