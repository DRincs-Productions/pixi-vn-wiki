...
icon: /react.svg
title: React UI
description: Как интегрировать Pixi’VN с React, включая настройку, шаблоны и лучшие библиотеки пользовательского интерфейса. Создайте визуальную новеллу или 2D игру на React.
---

**Что такое React?** React — это библиотека JavaScript для создания пользовательских интерфейсов (UI) для веб-сайтов, приложений и многого другого. Это бесплатная, открытая и поддерживаемая Meta (ранее Facebook) и большим сообществом.

Вы можете узнать больше о React на [веб-сайте React](https://react.dev/).

## Как добавить Pixi’VN в приложение React.

<Callout title="React template" type="info">

Существуют шаблоны Pixi’VN, доступные для использования с React. Вы можете узнать больше о них в разделе <DynamicLink href="/start#project-initialization">шаблоны</DynamicLink>.

Если вы хотите добавить Pixi’VN в существующее приложение React, выполните следующие шаги.

</Callout>

Сначала вам нужно приложение React и <DynamicLink href="/start#installation">установить pixi-vn</DynamicLink>. Рекомендуется использовать [Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project) для создания нового приложения React.
...
## Лучшие библиотеки компонентов для React.

Чтобы создать красивый пользовательский интерфейс, вы можете использовать некоторые из лучших библиотек компонентов пользовательского интерфейса для React:
