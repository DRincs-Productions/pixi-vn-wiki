...
There are Pixi’VN templates available that use React. You can read more about them in the <DynamicLink href="/start/getting-started#project-initialization">templates</DynamicLink> section.
