...
Доступны шаблоны Pixi’VN, использующие React. Подробнее о них можно прочитать в разделе <DynamicLink href="/start#project-initialization">templates</DynamicLink>.If you want to add Pixi’VN to an existing React application, follow the steps below.
