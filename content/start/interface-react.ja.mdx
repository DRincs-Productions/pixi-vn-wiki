...
Reactを使用したPixi’VNのテンプレートが用意されています。 詳細については、<DynamicLink href="/start#project-initialization">テンプレート</DynamicLink>セクションをご覧ください。既存のReactアプリケーションにPixi’VNを追加したい場合は、以下の手順に従ってください。
