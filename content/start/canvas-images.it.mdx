...
- Additional positions: <DynamicLink href="/start/canvas-position.md">Align</DynamicLink> and <DynamicLink href="/start/canvas-position">Position with percentage</DynamicLink>
