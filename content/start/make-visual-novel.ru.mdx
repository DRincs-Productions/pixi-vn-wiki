...
Для этого мы установим [`narration.choices`](/jsdoc/pixi-vn/index/interfaces/NarrationManagerInterface#choices) в массив вариантов выбора, созданных с помощью [`newChoiceOption`](/jsdoc/pixi-vn/index/functions/newChoiceOption) (для перехода к нарративному узлу или его вызова) и [`newCloseChoiceOption`](/jsdoc/pixi-vn/index/functions/newCloseChoiceOption) (для закрытия меню выбора без перехода куда-либо).
