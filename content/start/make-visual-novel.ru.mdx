...
Чтобы сделать визуальную новеллу более динамичной, можно использовать анимацию. For more information about how to use animations, see <DynamicLink href="/start/canvas-animations-effects">here</DynamicLink>.
...
In this example, my animation will take `steph` out of the scene and reinsert her in the next `step`. Я также отзеркалю её по оси x, чтобы убедиться, что она направлена в нужную сторону.
