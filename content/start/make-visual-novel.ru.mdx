...
After getting the input value, you can <DynamicLink href="/start/character.md#edit-characters-in-the-game">set the character name</DynamicLink> using the obtained value (<DynamicLink href="/ink/ink-character#edit-character-name-in-dialogues">Edit character name in _ink_</DynamicLink>).
