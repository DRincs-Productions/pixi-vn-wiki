...
Для загрузки и управления ассетами (изображениями, GIF, видео и т. д.) you will need to use `Assets`. `Assets` — это класс с множеством возможностей, предоставляемый библиотекой PixiJS. Подробнее см. [здесь](https://pixijs.com/8.x/guides/components/assets).
