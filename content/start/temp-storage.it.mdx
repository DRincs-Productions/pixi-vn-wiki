...
Per impostare una variabile temporanea, utilizza `storage.setTempVariable`. This function has the following parameters:
...
Per rimuovere una variabile temporanea, utilizzare `storage.removeTempVariable`. This function has the following parameters:
