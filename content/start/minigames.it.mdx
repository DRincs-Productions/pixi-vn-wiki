...
- Use components provided by the `PIXI` object, such as `Graphics`, `Sprite`, and `Text`, to create your minigame. `PIXI` is the PixiJS object, so you can use all its features.
...
Il team di Pixi’VN accoglie con favore nuove proposte e contributi per rendere questa biblioteca ancora più completa. You can create a [discussion](https://github.com/DRincs-Productions/pixi-vn/discussions/categories/show-and-tell) to share or propose your minigame implementations.
...
> **Note:** In Pixi’VN, a **step** represents a single action or moment in your visual novel, while a **label** is a named point in your script that you can jump to or reference. Both are fundamental elements for controlling flow and animation timing in your game.
