...
PixiJS is not designed to have multiple instances, so it is not recommended to install it separately in your project. If you want to use PixiJS directly, you can import the `PIXI` object from Pixi’VN.
