...
After getting the input value, you can <DynamicLink href="/start/character.md#edit-characters-in-the-game">set the character name</DynamicLink> using the obtained value (<DynamicLink href="/ink/ink-character#edit-character-name-in-dialogues">Edit character name in *ink*</DynamicLink>).
...
Now I can call this label `animation_01` from the main label `start`. (As explained <DynamicLink href="/ink/ink-label#use-the-call-script">here</DynamicLink> from *ink* I can call labels written in ts and vice versa.)
