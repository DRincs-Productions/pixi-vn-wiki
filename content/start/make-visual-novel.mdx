...
After getting the input value, you can [set the character name](/start/character.md#edit-characters-in-the-game) using the obtained value ([Edit character name in *ink*](/ink/ink-character#edit-character-name-in-dialogues)).
...
Now we could use character names within dialogues ([Use character name in dialogues in *ink*](/ink/ink-character#use-character-name-in-dialogues)).
...
To make the visual novel more dynamic, you can use transitions to show images. You can find more information about using transitions [here](/start/canvas-transition) ([Using transitions in *ink*](/ink/ink-canvas#show-a-canvas-component-with-transition-in-ink)).
...
To make the visual novel more dynamic, you can use animations. You can find more information about how to use animations [here](/start/canvas-animations-effects) ([Using animations in *ink*](/ink/ink-canvas#use-the-effects-in-ink)).
...
Now I can call this label `animation_01` from the main label `start`. (As explained [here](/ink/ink-label#use-the-call-script) from *ink* I can call labels written in ts and vice versa.)
