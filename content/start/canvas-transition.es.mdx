...
The `showWithDissolve` function displays a canvas element with a dissolve transition. Esta función tiene los siguientes parámetros:
...
The `removeWithDissolve` function removes a canvas element with a dissolve transition. Esta función tiene los siguientes parámetros:
...
The `showWithFade` function displays a canvas element with a fade transition. Esta función tiene los siguientes parámetros:
...
The `removeWithFade` function removes a canvas element with a fade transition. Esta función tiene los siguientes parámetros:
...
The `moveIn` function displays a canvas element with a move-in transition. Esta función tiene los siguientes parámetros:
...
The `moveOut` function removes a canvas element with a move-out transition. Esta función tiene los siguientes parámetros:
...
The `pushIn` function displays a canvas element with a push-in transition. Esta función tiene los siguientes parámetros:
...
The `pushOut` function removes a canvas element with a push-out transition. Esta función tiene los siguientes parámetros:
...
The `zoomIn` function displays a canvas element with a zoom-in transition. Esta función tiene los siguientes parámetros:
...
The `zoomOut` function removes a canvas element with a zoom-out transition. Esta función tiene los siguientes parámetros:
