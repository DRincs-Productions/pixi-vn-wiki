...
To set a temporary variable, use `storage.setTempVariable`. Cette fonction accepte les paramètres suivants:
...
To get a temporary variable, use the normal [`storage.get` function](#get).

## Remove

To remove a temporary variable, use `storage.removeTempVariable`. Cette fonction accepte les paramètres suivants:
