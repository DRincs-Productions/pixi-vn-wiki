...
一時変数を設定するには、[`storage.temp.set`](/jsdoc/pixi-vn/index/interfaces/StorageTempInterface#set) を使用します。
...
一時変数を削除するには、[`storage.temp.remove`](/jsdoc/pixi-vn/index/interfaces/StorageTempInterface#remove) を使用します。
