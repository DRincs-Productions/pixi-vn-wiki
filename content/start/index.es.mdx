...
Antes de usar el motor Pixi’VN, debes inicializar el juego. You can do this by calling the [`Game.init`](/jsdoc/pixi-vn/index/namespaces/Game/functions/init) method.
