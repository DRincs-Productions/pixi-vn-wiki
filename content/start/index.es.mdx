...
- Equivalente a las opciones que puedes usar al inicializar una [aplicación PixiJS](https://pixijs.com/8.x/guides/basics#creating-an-application). Además, admite las siguientes opciones:
