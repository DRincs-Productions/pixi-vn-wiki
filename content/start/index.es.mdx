...
- (Recomendado) [Git](https://git-scm.com/)
  - A [GitHub account](https://github.com/) - You will be able to use Copilot (Al assistant) and add comments to the wiki
...
- `options`: Equivalent to the options you can use when initializing a [PixiJS Application](https://pixijs.com/8.x/guides/components/application). Además, admite las siguientes opciones:
  - `id`: El ID que se asignará al elemento canvas.
  - `resizeMode`: El modo de cambio de tamaño a utilizar. Valores posibles:
    - `none`: Sin cambio de tamaño.
    - `contain`: El canvas se redimensionará para ajustarse al elemento padre manteniendo su proporción. (predeterminado)
