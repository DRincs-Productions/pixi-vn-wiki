...
Вы можете использовать этот способ с синтаксисом _ink_. See more <DynamicLink href="/ink/character#edit">here</DynamicLink>.
...
Вы можете использовать этот способ с синтаксисом _ink_. See more <DynamicLink href="/ink/character#character-emotions">here</DynamicLink>.
