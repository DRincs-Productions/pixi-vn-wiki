...
**What are `characters`?** Characters are the actors that appear in a visual novel. В Pixi’VN персонажи создаются с использованием класса `CharacterBaseModel` или [пользовательского класса](#custom-class).
