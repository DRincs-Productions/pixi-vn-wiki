...
The simplest way to show a video on the canvas is to use the [`showVideo`](/jsdoc/pixi-vn/index/functions/showVideo) function. 该函数将 [`load`](/jsdoc/pixi-vn/index/classes/ImageSprite#load) 和 [`canvas.add`](/jsdoc/pixi-vn/index/interfaces/CanvasManagerInterface#add) 合并为一步。
