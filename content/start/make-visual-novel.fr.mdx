...
Pour charger et manipuler des assets (images, Gif, vidéos, etc.), you will need to use `Assets`. `Assets` est une classe riche en fonctionnalités provenant de la bibliothèque PixiJS. Pour plus d’informations, consultez [ici](https://pixijs.com/8.x/guides/components/assets).
