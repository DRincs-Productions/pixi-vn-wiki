...
Sono disponibili anche funzioni pensate per la gestione dei suoni nei menu, come ad esempio nella schermata delle impostazioni.

Tutte le modifiche fatte da queste funzioni non saranno salvate nei salvataggi di gioco, quindi al caricamento di un salvataggio, i suoni torneranno allo stato in cui erano prima di essere modificati da queste funzioni.

Le funzioni `pauseUnsavedAll` e `resumeUnsavedAll` sono pensate per essere usate quando si apre un menu, come ad esempio le impostazioni, e quando si chiude. La prima funzione metterà in pausa tutti i suoni che non sono già in pausa, mentre la seconda riprenderà tutti i suoni che sono stati messi in pausa dalla prima funzione.

Metre le funzioni `playTransient` e `stopTransientAll` sono pensate per suoni temporanei, come ad esempio i suoni di interazione con la UI. La prima funzione avvierà un suono che non sarà salvato nei salvataggi di gioco, mentre la seconda fermerà tutti i suoni avviati con la prima funzione.
