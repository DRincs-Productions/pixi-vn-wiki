...
Con Pixi’VN puoi usare JavaScript/TypeScript per scrivere la narrazione. You can also use various narrative languages (potentially you can integrate any narrative language using <DynamicLink href="/json">PixiVNJson</DynamicLink>).
