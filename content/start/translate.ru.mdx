...
- The <DynamicLink href="/start/interface">UI</DynamicLink> texts, that is, the texts that are contained in screens, settings, quick buttons, etc... то есть всё, что не является частью повествования.
...
- <DynamicLink href="/ink/ink-translate">Translate the narration (*ink*)</DynamicLink>
