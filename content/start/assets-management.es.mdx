...
It is recommended to name each bundle based on **where it will be used**. Por ejemplo:
...
Puedes usar este método con la sintaxis *ink*. See more <DynamicLink href="/ink/assets">here</DynamicLink>.
