...
The simplest way to show a video on the canvas is to use the [`showVideo`](/jsdoc/pixi-vn/index/functions/showVideo) function. Esta función combina [`load`](/jsdoc/pixi-vn/index/classes/ImageSprite#load) y [`canvas.add`](/jsdoc/pixi-vn/index/interfaces/CanvasManagerInterface#add).
...
To add an video to the canvas, use the [`addVideo`](/jsdoc/pixi-vn/index/functions/addVideo) function. Esta función solo añade el componente al lienzo; **no** lo muestra ni carga su textura. Utiliza [`canvas.add`](/jsdoc/pixi-vn/index/interfaces/CanvasManagerInterface#add) para agregar el componente al lienzo.
