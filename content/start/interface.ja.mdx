...
To add an HTML UI Layer, you can use the `canvas.addHtmlLayer` function. この関数は以下のパラメータを持ちます：
...
To get the HTML element of the layer, you can use the `canvas.getHtmlLayer` function. この関数は以下のパラメータを持ちます：

- `id`: The id of the layer.

To remove an HTML UI Layer, you can use the `canvas.removeHtmlLayer` function. この関数は以下のパラメータを持ちます：
...
To add a PixiJS UI Layer, you can use the `canvas.addLayer` function. この関数は以下のパラメータを持ちます：
...
To get the PixiJS Container of the layer, you can use the `canvas.getLayer` function. この関数は以下のパラメータを持ちます：

- `label`: The PixiJS Container label.

To remove a PixiJS UI Layer, you can use the `canvas.removeLayer` function. この関数は以下のパラメータを持ちます：
