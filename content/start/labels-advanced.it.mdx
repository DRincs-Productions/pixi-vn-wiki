...
È possibile impostare questa funzione passandola alla proprietà `onLoadingLabel` nelle opzioni della `label`. This function has the following parameters:
...
`onStepStart` è una funzione eseguita prima di ogni `step` di una `label`. Impostarlo tramite la proprietà `onStepStart` nelle opzioni della `label`. This function has the following parameters:
...
`onStepEnd` è una funzione eseguita dopo ogni `step` di una `label`. Impostarlo tramite la proprietà `onStepEnd` nelle opzioni della `label`. This function has the following parameters:
