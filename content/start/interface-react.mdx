...
There are some Pixi’VN templates available that use React. You can read more about them in the [templates](/start/getting-started#project-initialization) section.

Instead if you want to add Pixi’VN to an existing React application, you can follow the steps below.
</Callout>

First of all you need to have a React application and [install pixi-vn](/start/getting-started#installation). Is recommended to use [Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project) to create a new React application.
