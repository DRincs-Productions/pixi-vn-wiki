...
icon: /react.svg
title: React UI
description: How to integrate Pixi’VN with React, including setup, templates, and best UI libraries.
---
...
There are some Pixi’VN templates available that use React. You can read more about them in the <DynamicLink href="/start/getting-started#project-initialization">templates</DynamicLink> section.

Instead if you want to add Pixi’VN to an existing React application, you can follow the steps below.
</Callout>

First of all you need to have a React application and <DynamicLink href="/start/getting-started#installation">install pixi-vn</DynamicLink>. Is recommended to use [Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project) to create a new React application.
