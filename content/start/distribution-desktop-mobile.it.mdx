...
<Accordion title="what_is_tauri" id="what-is-tauri">
...
I <DynamicLink href="/start#project-initialization">template multi-dispositivo</DynamicLink> includono il file `/.github/workflows/tauri.yml`. Tale flusso di lavoro crea artefatti di rilascio (pacchetti di installazione) per più sistemi operativi.
