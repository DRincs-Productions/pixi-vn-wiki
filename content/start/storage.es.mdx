...
To set a variable in the game storage, use `storage.set`. Esta función tiene los siguientes parámetros:
...
To get a variable from the game storage, use `storage.get`. Esta función tiene los siguientes parámetros:
...
To remove a variable from the game storage, use `storage.remove`. Esta función tiene los siguientes parámetros:
