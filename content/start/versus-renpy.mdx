...
With Pixi’VN, you can use JavaScript/TypeScript to write the narration. You can also use various narrative languages (potentially you can integrate any narrative language using <DynamicLink href="/jsdoc/pixi-vn-json">PixiVNJson</DynamicLink>).
