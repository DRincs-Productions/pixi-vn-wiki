...
You can customize a choice menu option by adding properties to the [`ChoiceInterface`](/jsdoc/pixi-vn/index/interfaces/ChoiceInterface) interface. Ad esempio, aggiungi una proprietà `icon` per visualizzare un'icona.
