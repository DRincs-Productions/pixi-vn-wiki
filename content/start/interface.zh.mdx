...
To add an HTML UI Layer, you can use the `canvas.addHtmlLayer` function. 该函数具有以下参数：
...
To get the HTML element of the layer, you can use the `canvas.getHtmlLayer` function. 该函数具有以下参数：

- `id`: The id of the layer.

To remove an HTML UI Layer, you can use the `canvas.removeHtmlLayer` function. 该函数具有以下参数：
...
To add a PixiJS UI Layer, you can use the `canvas.addLayer` function. 该函数具有以下参数：
...
To get the PixiJS Container of the layer, you can use the `canvas.getLayer` function. 该函数具有以下参数：

- `label`: The PixiJS Container label.

To remove a PixiJS UI Layer, you can use the `canvas.removeLayer` function. 该函数具有以下参数：
