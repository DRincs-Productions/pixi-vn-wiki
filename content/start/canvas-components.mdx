...
* `getInstance`: A function that returns an instance of the canvas component. This function is used when the canvas state is reset. If not set, it will use the default constructor of the class.
