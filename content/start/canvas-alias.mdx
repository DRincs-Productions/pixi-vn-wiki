...
To edit the alias of a canvas component, you can use the `canvas.editAlias`. If the alias has a or more <DynamicLink href="/start/canvas-tickers">tickers</DynamicLink> associated, it will be automatically edited in the ticker.
...
This is very useful if you want to run some <DynamicLink href="/start/canvas-animations-effects">animations or effects</DynamicLink> at the entire window. Some features are not allowed on this item, such as deletion.
