...
This is very useful if you want to run some <DynamicLink href="/start/canvas-animations-effects">animations or effects</DynamicLink> at the entire layer. Some features are not allowed on this item, such as deletion.
