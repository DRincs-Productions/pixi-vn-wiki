...
As explained in more detail <DynamicLink href="/start/canvas#pixijs-differences">here</DynamicLink>, the entire rendering part of Pixi’VN is based on PixiJS. Sfruttando i vantaggi dei <DynamicLink href="/start/interface#adding-pixijs-ui-layers">PixiJS Layers</DynamicLink>, puoi usare PixiJS per creare schermate di interfaccia utente personalizzate.
