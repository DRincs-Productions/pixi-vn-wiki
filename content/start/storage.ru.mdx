...
Вы можете использовать этот способ с синтаксисом _ink_. See more <DynamicLink href="/ink/storage">here</DynamicLink>.

</Callout>

## Set

To set a variable in the game storage, use `storage.set`. Эта функция принимает следующие параметры:
...
To get a variable from the game storage, use `storage.get`. Эта функция принимает следующие параметры:
...
To remove a variable from the game storage, use `storage.remove`. Эта функция принимает следующие параметры:
