...
To set a variable in the game storage, use `storage.set`. Cette fonction accepte les paramètres suivants:
...
To get a variable from the game storage, use `storage.get`. Cette fonction accepte les paramètres suivants:
...
To remove a variable from the game storage, use `storage.remove`. Cette fonction accepte les paramètres suivants:
