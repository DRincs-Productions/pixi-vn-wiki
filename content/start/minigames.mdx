...
The best way to create a minigame is to use the `PIXI` component which would be an object composed of `pixi.js`. So you can use all the features of `pixi.js` to create your minigame.
