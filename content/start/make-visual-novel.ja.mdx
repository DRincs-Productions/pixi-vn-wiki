...
最初のステップは、新しいプロジェクトを作成することです。 テンプレートから新しいプロジェクトを作成する方法についての詳細は <DynamicLink href="/start#project-initialization">こちら</DynamicLink> を参照してください。 ここでは「Visual Novel - React」テンプレートを使用します。
