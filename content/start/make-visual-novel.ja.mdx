...
視覚小説をよりダイナミックにするために、アニメーションを使用できます。 アニメーションの使用方法についての詳細は<DyanmicLink href="/start/canvas-animations-effects">こちら</DynamicLink>を参照してください。
...
<DynamicLink href="/ink/ink-label#use-the-call-script">ここ</DynamicLink>で説明したように、*ink*からtsで書かれた`labels`を呼び出すことができ、逆もまた同様です。
