...
Il existe des modèles Pixi’VN disponibles qui utilisent React. Vous pouvez en savoir plus à leur sujet dans la section <DynamicLink href="/start#project-initialization">modèles</DynamicLink>.If you want to add Pixi’VN to an existing React application, follow the steps below.
