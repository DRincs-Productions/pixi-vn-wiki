...
Des templates Pixi’VN utilisant React sont disponibles. Vous pouvez en savoir plus dans la section <DynamicLink href="/start#project-initialization">templates</DynamicLink>.If you want to add Pixi’VN to an existing React application, follow the steps below.
