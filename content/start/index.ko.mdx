...
Pixi’VN에는 AI 코딩 어시스턴트(예: Claude Code)에게 엔진의 각 부분을 올바르게 사용하는 방법을 알려주는 [Agent Skills](https://www.skills.sh/) 세트가 포함되어 있습니다. Claude Code를 사용한다면 다음 명령으로 프로젝트에 모두 설치할 수 있습니다:
