...
In Pixi’VN, il dialogo è un oggetto che contiene informazioni su _chi_ e _cosa_ viene detto in quel momento. Its functionality can be broader as it can also be used for other purposes, such as monologues, soliloquies or to display a message to the player. Per questo motivo è più appropriato considerarlo come un testo che può essere collegato ad un <DynamicLink href="/start/character#use-characters-in-the-game">personaggio</DynamicLink>.
