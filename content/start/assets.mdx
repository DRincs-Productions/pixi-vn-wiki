...
Once you have your assets ready, you need to manually define which ones your game can use and how they are grouped into bundles. It is strongly recommended to follow the [asset loading best practices](/assets-management) to minimize loading times and avoid blocking the game unnecessarily.
