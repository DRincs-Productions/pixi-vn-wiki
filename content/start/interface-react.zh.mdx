...
icon: /react.svg
title: React UI
description: 如何将 Pixi’VN 集成到 React 中，包括设置、模板和最佳 UI 库。
---
...
有可用的 Pixi’VN 模板，它们使用 React。 You can read more about them in the <DynamicLink href="/start#project-initialization">templates</DynamicLink> section.
