...
icon: /react.svg
title: React UI
description: 如何将 Pixi’VN 与 React 集成，包括设置、模板以及最佳 UI 库。 Create a React visual novel or story-driven game.
---
...
提供了使用 React 的 Pixi’VN 模板。 你可以在 <DynamicLink href="/start#project-initialization">templates</DynamicLink> 部分中阅读更多相关内容。If you want to add Pixi’VN to an existing React application, follow the steps below.
