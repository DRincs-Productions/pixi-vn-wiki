...
Загрузка и работа с ресурсами (изображениями, gif-файлами, видео...) вам необходимо использовать `Assets`. `Assets` - это класс с множеством функций, который поставляется из библиотеки PixiJS, если вы хотите получить больше информации, читайте [здесь](https://pixijs.com/8.x/guides/components/assets). It is also very important that you read this documentation to better <DynamicLink href="/start/assets-management">organize the uploading of your assets</DynamicLink>.
