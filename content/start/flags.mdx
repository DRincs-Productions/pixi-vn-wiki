...
This mechanic has much less impact on save size than directly <DynamicLink href="/start/storage#set-a-variable-in-the-game-storage">saving a boolean in Game Sorage</DynamicLink>.
