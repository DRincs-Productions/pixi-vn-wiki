...
In the canvas you can only add Pixi’VN components. In the UI you can add any HTML element or use any UI component library, so you can create much more complex interfaces.
