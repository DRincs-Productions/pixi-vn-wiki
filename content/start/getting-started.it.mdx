...
Ora devi [inizializzare Pixi’VN](#initialize-the-game) prima di utilizzare l'engine. Ad esempio, puoi aggiungere il seguente codice a `main.ts` o `index.ts` (a seconda della configurazione del progetto).
