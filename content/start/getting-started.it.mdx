...
- `options`: Equivalente alle opzioni che puoi utilizzare durante l'inizializzazione di un'[applicazione PixiJS](https://pixijs.com/8.x/guides/basics/getting-started#creating-an-application). Le seguenti opzioni sono obbligatorie:
