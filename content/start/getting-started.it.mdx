...
Now you must [initialize Pixi’VN](#project-initialization) before using the engine. Ad esempio, puoi aggiungere il seguente codice a `main.ts` o `index.ts` (a seconda della configurazione del progetto).
