...
React를 사용하는 Pixi’VN 템플릿을 이용할 수 있습니다. 이에 대해 <DynamicLink href="/start#project-initialization">템플릿</DynamicLink> 섹션에서 더 알아볼 수 있습니다.기존 React 애플리케이션에 Pixi’VN을 추가하고 싶다면 아래 단계를 따르세요.
