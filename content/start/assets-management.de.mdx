...
It is recommended to name each bundle based on **where it will be used**. Zum Beispiel:
...
Sie können diese Methode mit der *ink*-Syntax verwenden. See more <DynamicLink href="/ink/assets">here</DynamicLink>.
