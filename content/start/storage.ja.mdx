...
To set a variable in the game storage, use `storage.set`. この関数は以下のパラメータを持ちます：
...
To get a variable from the game storage, use `storage.get`. この関数は以下のパラメータを持ちます：
...
To remove a variable from the game storage, use `storage.remove`. この関数は以下のパラメータを持ちます：
