...
To set a variable in the game storage, use `storage.set`. 该函数具有以下参数：
...
To get a variable from the game storage, use `storage.get`. 该函数具有以下参数：
...
To remove a variable from the game storage, use `storage.remove`. 该函数具有以下参数：
