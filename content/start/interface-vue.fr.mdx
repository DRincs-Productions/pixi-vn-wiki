---
title: Vue UI
description: Comment intégrer Pixi’VN avec Vue, y compris la configuration, les modèles et des exemples d'UI. Créez un visual novel ou un jeu narratif avec Vue.
---
...
Vous pouvez en savoir plus sur Vue sur le [site Web de Vue](https://vuejs.org/).
...
Tout d'abord, vous avez besoin d'une application Vue et de <DynamicLink href="/start#installation">installer pixi-vn</DynamicLink>. Il est recommandé d'utiliser [Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project) pour créer une nouvelle application Vue.
