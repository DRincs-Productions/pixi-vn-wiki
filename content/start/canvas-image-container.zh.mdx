...
- `imageUrls` (Optional): An array of image URLs or paths. 如果你已经初始化了<DynamicLink href="/start/assets-management#initialize-the-asset-matrix-at-project-start">资源矩阵</DynamicLink>，你可以使用纹理的别名。
...
This function returns an `ImageContainer` that you can use to manipulate the component. 该函数具有以下参数：
