...
In tutti i modelli *ink* è stato introdotto un <DynamicLink href="/ink/hashtag">comando hashtag personalizzato</DynamicLink> per navigare tra i percorsi. To do this, you need to use the following syntax:
