...
In all ink templates, a <DynamicLink href="/ink/hashtag">custom hashtag script</DynamicLink> has been introduced to navigate between routes. Per fare ciò, è necessario utilizzare la seguente sintassi:
