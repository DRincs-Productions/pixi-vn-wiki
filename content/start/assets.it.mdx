...
To load and manipulate assets (images, gifs, videos, etc.) sarà necessario utilizzare `Assets`. `Assets` is a class with many features and comes from the PixiJS library. For more information, read [here](https://pixijs.com/8.x/guides/components/assets). È inoltre molto importante leggere questa documentazione per <DynamicLink href="/start/assets-management">organizzare al meglio il caricamento delle risorse</DynamicLink>.
