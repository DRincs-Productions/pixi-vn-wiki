...
In tutti i modelli è incluso un service worker per memorizzare nella cache le risorse esterne (immagini, suoni, video, ecc.) utilizzate nel gioco. This improves performance and reduces loading times for players.
