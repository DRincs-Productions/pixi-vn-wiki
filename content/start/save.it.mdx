...
Salvare e caricare è una funzionalità fondamentale che consente ai giocatori di salvare i propri progressi e continuare in seguito. This is essential for story-driven games, allowing players to resume the story from where they left off.
...
Per caricare un salvataggio, utilizza `Game.restoreGameState`. This function has the following parameters:
