...
The `showWithDissolve` function displays a canvas element with a dissolve transition. Эта функция принимает следующие параметры:
...
The `removeWithDissolve` function removes a canvas element with a dissolve transition. Эта функция принимает следующие параметры:
...
The `showWithFade` function displays a canvas element with a fade transition. Эта функция принимает следующие параметры:
...
The `removeWithFade` function removes a canvas element with a fade transition. Эта функция принимает следующие параметры:
...
The `moveIn` function displays a canvas element with a move-in transition. Эта функция принимает следующие параметры:
...
The `moveOut` function removes a canvas element with a move-out transition. Эта функция принимает следующие параметры:
...
The `pushIn` function displays a canvas element with a push-in transition. Эта функция принимает следующие параметры:
...
The `pushOut` function removes a canvas element with a push-out transition. Эта функция принимает следующие параметры:
...
The `zoomIn` function displays a canvas element with a zoom-in transition. Эта функция принимает следующие параметры:
...
The `zoomOut` function removes a canvas element with a zoom-out transition. Эта функция принимает следующие параметры:
