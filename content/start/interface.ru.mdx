...
To add an HTML UI Layer, you can use the `canvas.addHtmlLayer` function. Эта функция принимает следующие параметры:
...
To get the HTML element of the layer, you can use the `canvas.getHtmlLayer` function. Эта функция принимает следующие параметры:

- `id`: The id of the layer.

To remove an HTML UI Layer, you can use the `canvas.removeHtmlLayer` function. Эта функция принимает следующие параметры:
...
To add a PixiJS UI Layer, you can use the `canvas.addLayer` function. Эта функция принимает следующие параметры:
...
To get the PixiJS Container of the layer, you can use the `canvas.getLayer` function. Эта функция принимает следующие параметры:

- `label`: The PixiJS Container label.

To remove a PixiJS UI Layer, you can use the `canvas.removeLayer` function. Эта функция принимает следующие параметры:
