...
- `ink/hashtag-commands.ts` — custom hashtag commands parsed from **_ink_** scripts. See <DynamicLink href="/ink/hashtag">**_ink_** hashtag commands</DynamicLink>.
- `ink/text-replaces.ts` — text replacement rules applied to **_ink_** dialogue. See <DynamicLink href="/ink/replacement">**_ink_** text replacements</DynamicLink>.
