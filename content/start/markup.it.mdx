...
Data la sua semplicità e popolarità si consiglia di utilizzare <DynamicLink href="/start/markup-markdown.md">**Markdown**</DynamicLink>. Inoltre, poiché spesso è possibile combinare Markdown con HTML, è possibile utilizzare il CSS per lo stile del testo. Si consiglia di utilizzare un framework CSS come <DynamicLink href="/start/markup-tailwindcss">**Tailwind CSS**</DynamicLink>.
