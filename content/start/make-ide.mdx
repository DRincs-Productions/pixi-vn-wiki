...
- The simplest and most portable approach is to export a JSON that follows the <DynamicLink href="/jsdoc/pixi-vn-json">PixiVNJson</DynamicLink> model. That JSON contains the sequence of instructions Pixi’VN will execute and can be injected into a Pixi’VN template by the user or your tool.
...
- If your tool already exports or internally serializes instructions as objects or JSON, create a small mapping layer that converts your format to the <DynamicLink href="/jsdoc/pixi-vn-json">PixiVNJson</DynamicLink> model.
