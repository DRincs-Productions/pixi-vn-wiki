...
The best way to do this is to create your own tool using <DynamicLink href="/json">PixiVNJson</DynamicLink>. In short, this consists of generating a json that respects the <DynamicLink href="/json">PixiVNJson</DynamicLink> model. This json will contain the list of instructions that Pixi’VN will run. Finally, this json will be inserted into a Pixi’VN template, either by the user or by the tool.
...
The only thing you will need to do is remap your json object to one that respects the <DynamicLink href="/json">PixiVNJson</DynamicLink> model.
