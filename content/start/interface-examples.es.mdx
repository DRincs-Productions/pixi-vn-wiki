---
title: Ejemplos de pantallas de UI
description: Proporciona ejemplos de pantallas de UI para Pixi’VN, mostrando componentes de React y Vue, y demostrando hooks (por ejemplo, useQueryDialogue, useQueryChoiceMenuOptions, useQueryCanGoNext) e integración con la narrativa para elecciones, siguiente/atrás, solicitudes de entrada e historial.
---

:::tip[IA]

Puedes usar el botón de arriba para crear tu propia pantalla de UI con IA.

:::

:::tip

Estos ejemplos usan primitivas de UI simples (`Button`, `Card`, `Avatar`, `Dialog`, `Input`, ...) importadas desde una carpeta `components/ui`, similar a lo que ofrecen [shadcn/ui](https://ui.shadcn.com) (React) o [shadcn-vue](https://www.shadcn-vue.com). Reemplázalos por los componentes equivalentes de tu propia biblioteca de UI.

:::

<Accordions>

<Accordion title="Pantalla de UI de diálogo narrativo" id="narrative-dialogue">
...
<Accordion title="Pantalla de UI del menú de elecciones" id="choice-menu">
...
<Accordion title="Continuar haciendo clic en la pantalla" id="go-next">

En lugar de un botón «siguiente» dedicado, envuelve la pantalla narrativa en una superposición que avanza la narración cada vez que el jugador hace clic en cualquier parte de ella.
...
Envuelve la pantalla de diálogo narrativo con él, para que un clic en cualquier parte de la pantalla continúe la narración (elementos como el menú de elecciones, el botón de retroceso y el diálogo de entrada llaman a `stopPropagation()` para que interactuar con ellos no dispare también un «siguiente»):
...
<Accordion title="Botón de retroceso" id="go-back">
...
<Accordion title="Diálogo de UI de solicitud de entrada" id="input-prompt">
