...
The simplest way to show an text on the canvas is to use the `showText` function.

This function returns an `Text` that you can use to manipulate the component. Questa funzione ha i seguenti parametri:
