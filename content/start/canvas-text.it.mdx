...
Il componente `Text` estende il componente [`PixiJS.Text`](https://pixijs.com/8.x/guides/components/scene-objects/text), così puoi utilizzare tutti i metodi e le proprietà di `PixiJS.Text`. Viene utilizzato per visualizzare il testo sul canvas.
...
Questa funzione restituisce un `Text` che puoi utilizzare per manipolare il componente. Questa funzione ha i seguenti parametri:
