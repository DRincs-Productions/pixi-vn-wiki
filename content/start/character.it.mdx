...
- `id`: A unique identifier (string). Viene utilizzato per fare riferimento al personaggio nel gioco (deve essere univoco). Se vuoi creare un [personaggio con un'"emozione", puoi passare un oggetto](#character-emotions).
