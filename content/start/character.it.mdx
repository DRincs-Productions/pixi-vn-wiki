...
**Cosa sono i characters?** I personaggi (characters) sono gli attori che appaiono in una visual novel. In Pixi’VN, characters are created using the `CharacterBaseModel` class or a [custom class](#custom-class).
