...
To initialize a character, you need to create a new instance of the `CharacterBaseModel` class (or your [custom class](#custom-character)) and add it into a game character dictionary, when the game is initialized.
