...
- `props`: An object with the character's properties.
  Le proprietà sono:
  - `name`: Il nome del personaggio. ( Required )
  - `surname`: Il cognome del personaggio. ( Optional )
  - `age`: L'età del personaggio. ( Optional )
  - `icon`: URL dell'immagine dell'icona del personaggio. ( Optional )
  - `color`: Il colore del personaggio. ( Optional )
