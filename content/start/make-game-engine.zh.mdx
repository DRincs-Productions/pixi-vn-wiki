...
The first `step` is to create a new project. 有关如何从模板创建新项目的更多信息，请参阅 <DynamicLink href="/start#project-initialization">这里</DynamicLink>。 The "Game Engine" template is a simple project that contains the basic structure of a game engine. By default, it exports the basic functionality of pixi-vn while removing anything unused from the package.
