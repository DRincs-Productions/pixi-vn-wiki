...
<Accordion title="What, exactly, is anchor/pivot?" id="what-exactly-is-anchor-pivot">

Let’s think of it in terms of something you may be more familiar with. Instead of positioning an element on a screen, you are trying to pin a photo onto a cork board. You have three things:
