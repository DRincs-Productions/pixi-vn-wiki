...
It is recommended to name each bundle based on **where it will be used**. Par exemple :
...
Vous pouvez utiliser cette méthode avec la syntaxe *ink*. See more <DynamicLink href="/ink/assets">here</DynamicLink>.
