...
It is recommended to name each bundle based on **where it will be used**. 예를 들어:
...
이 메서드는 *ink* 문법과 함께 사용할 수 있습니다. See more <DynamicLink href="/ink/assets">here</DynamicLink>.
