...
It is recommended to name each bundle based on **where it will be used**. Например:
...
Этот метод можно использовать с синтаксисом *ink*. See more <DynamicLink href="/ink/assets">here</DynamicLink>.
