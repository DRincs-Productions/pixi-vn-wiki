...
- `options`: Equivalent to the options you can use when initializing a [PixiJS Application](https://pixijs.com/8.x/guides/components/application). Inoltre, supporta le seguenti opzioni:
  - `id`: id da assegnare all'elemento canvas.
  - `resizeMode`: Modalità di ridimensionamento da utilizzare. I valori possibili sono:
    - `none`: Nessun ridimensionamento.
    - `contain`: Il canvas verrà ridimensionata per adattarsi all'elemento padre, mantenendone le proporzioni. (predefinito)
