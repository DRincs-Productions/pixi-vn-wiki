...
Prima di utilizzare l'engine Pixi'VN, è necessario inizializzare il gioco. You can do this by calling the [`Game.init`](/jsdoc/pixi-vn/index/namespaces/Game/functions/init) method.
