...
* (Raccomandato) [Git](https://git-scm.com/)
  * Un [account GitHub](https://github.com/) - Potrai utilizzare Copilot (assistente Ia), la generazione automatica di pacchetti da distribuire e aggiungere commenti al wiki
