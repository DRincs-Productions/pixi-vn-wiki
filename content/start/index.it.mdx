...
- Endpoint per gestire personaggi, label e manifest degli assets.
  ...
  - `GET /pixi-vn/labels` - Recupera l'elenco delle label registrate.
  - `POST /pixi-vn/labels` - Aggiornare l'elenco delle label registrate.
