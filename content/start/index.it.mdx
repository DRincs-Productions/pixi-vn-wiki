...
- `options`: Equivalente alle opzioni che puoi utilizzare durante l'inizializzazione di un'[applicazione PixiJS](https://pixijs.com/8.x/guides/basics#creating-an-application). Inoltre, supporta le seguenti opzioni:
