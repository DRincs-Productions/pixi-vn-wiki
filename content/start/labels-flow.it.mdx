...
description: Describes how to control the narrative flow in Pixi'VN using labels, including call, jump, and close function labels.
---
...
Quando si chiama una label, viene eseguito il primo step di quella label. Se prima della chiamata era in esecuzione un'altra label, i passaggi rimanenti della label precedente riprenderanno al termine della label chiamata.
