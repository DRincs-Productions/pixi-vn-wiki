...
- `options` (Optional): [`motion` options](https://motion.dev/docs/animate#options) for the animation, including duration, `easing`, and ticker. Le seguenti opzioni estendono quelle di `motion`:
