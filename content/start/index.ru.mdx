...
- `options`: Параметры, аналогичные тем, что используются при инициализации [приложения PixiJS](https://pixijs.com/8.x/guides/basics#creating-an-application). Additionally, it supports the following options:
