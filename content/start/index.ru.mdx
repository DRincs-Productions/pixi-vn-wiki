...
- `options`: Параметры, аналогичные тем, что используются при инициализации [приложения PixiJS](https://pixijs.com/8.x/guides/basics#creating-an-application). Обязательные параметры:
  - `width`: ширина canvas.
