...
È possibile utilizzare questo metodo con la sintassi _ink_. See more <DynamicLink href="/ink/sound">here</DynamicLink>.
...
- `soundUrl` (Optional): The URL or path. If you have initialized the <DynamicLink href="/start/assets-management#initialize-the-asset-matrix-at-project-start">asset matrix</DynamicLink>, you can use the alias of the sound. Se non si specifica l'URL, verrà utilizzato l'alias come URL.
