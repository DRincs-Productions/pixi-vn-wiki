...
Rispetto ai Pivot, gli Anchor sono più facili da usare. Puoi saperne di più sulle loro differenze [qui](https://pixijs.com/8.x/guides/components/sprites#pivot-vs-anchor).
...
Align is a feature originally created for **_Ren'Py_**, which was also introduced in Pixi’VN. Align combina [position](#position-pixel) e [anchor/pivot](#anchor-and-pivot) per offrirti un modo più intuitivo per posizionare i tuoi componenti all'inizio, al centro o alla fine dello schermo.
