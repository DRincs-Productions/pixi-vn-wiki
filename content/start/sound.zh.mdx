...
声音模块是对[PixiJS Sound](https://github.com/pixijs/sound)库的封装。 It provides a simple interface for playing sounds and saves the current state at each <DynamicLink href="/start/labels">`step`</DynamicLink>.

<Callout title="ink" type="info">

此方法可以与_ink_语法一起使用。 See more <DynamicLink href="/ink/sound">here</DynamicLink>.
