...
* The simplest and most portable approach is to export a JSON that follows the [PixiVNJson](/jsdoc/pixi-vn-json) model. 该文件包含了Pixi'VN将要执行的指令序列，可以由用户或你的工具导入到Pixi'VN模板中。
