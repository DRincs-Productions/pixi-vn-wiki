...
Sono disponibili modelli Pixi'VN che utilizzano React. Per ulteriori informazioni, consulta la sezione <DynamicLink href="/start#project-initialization">templates</DynamicLink>.If you want to add Pixi’VN to an existing React application, follow the steps below.
