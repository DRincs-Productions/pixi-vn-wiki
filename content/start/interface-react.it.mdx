...
Sono disponibili alcuni modelli Pixi'VN che utilizzano React. Per ulteriori informazioni, consulta la sezione <DynamicLink href="/start/getting-started#project-initialization">templates</DynamicLink>.

Se invece vuoi aggiungere Pixi'VN a un'applicazione React esistente, puoi seguire i passaggi seguenti.

</Callout>

Prima di tutto devi avere un'applicazione React e <DynamicLink href="/start/getting-started#installation">installare pixi-vn</DynamicLink>. Si consiglia di utilizzare [Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project) per creare una nuova applicazione React.
