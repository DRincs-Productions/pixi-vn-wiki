...
First, you need a React application and to <DynamicLink href="/start/getting-started#installation">install pixi-vn</DynamicLink>. It is recommended to use [Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project) to create a new React application.
