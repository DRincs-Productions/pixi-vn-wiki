...
There are Pixi’VN templates available that use React. Per ulteriori informazioni, consulta la sezione <DynamicLink href="/start/getting-started#project-initialization">templates</DynamicLink>.
