...
Sono disponibili modelli Pixi'VN che utilizzano React. You can read more about them in the <DynamicLink href="/start#project-initialization">templates</DynamicLink> section.

Se vuoi aggiungere Pixi'VN a un'applicazione React esistente, segui i passaggi sottostanti.

</Callout>

First, you need a React application and to <DynamicLink href="/start#installation">install pixi-vn</DynamicLink>. Si consiglia di utilizzare [Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project) per creare una nuova applicazione React.
