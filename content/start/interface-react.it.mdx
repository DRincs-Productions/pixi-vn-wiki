...
icon: /react.svg
title: React UI
description: Come integrare Pixi'VN con React, inclusi configurazione, modelli e le migliori librerie UI.
---
...
Sono disponibili modelli Pixi'VN che utilizzano React. Per ulteriori informazioni, consulta la sezione <DynamicLink href="/start/getting-started#project-initialization">templates</DynamicLink>.

Se vuoi aggiungere Pixi'VN a un'applicazione React esistente, segui i passaggi sottostanti.

</Callout>

Per prima cosa, hai bisogno di un'applicazione React e di <DynamicLink href="/start/getting-started#installation">installare pixi-vn</DynamicLink>. Si consiglia di utilizzare [Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project) per creare una nuova applicazione React.
