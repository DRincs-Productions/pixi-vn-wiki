...
The `showWithDissolve` function show a canvas element with dissolve transition. Questa funzione ha i seguenti parametri:
...
The `removeWithDissolve` function remove a canvas element with dissolve transition. Questa funzione ha i seguenti parametri:
...
The `showWithFade` function show a canvas element with fade transition. Questa funzione ha i seguenti parametri:
...
The `removeWithFade` function remove a canvas element with fade transition. Questa funzione ha i seguenti parametri:
...
The `moveIn` function show a canvas element with move in transition. Questa funzione ha i seguenti parametri:
...
The `moveOut` function remove a canvas element with move out transition. Questa funzione ha i seguenti parametri:
...
The `pushIn` function show a canvas element with push in transition. Questa funzione ha i seguenti parametri:
...
The `pushOut` function remove a canvas element with push out transition. Questa funzione ha i seguenti parametri:
...
The `zoomIn` function show a canvas element with zoom in transition. Questa funzione ha i seguenti parametri:
...
The `zoomOut` function remove a canvas element with zoom out transition. Questa funzione ha i seguenti parametri:
