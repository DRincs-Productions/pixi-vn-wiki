...
La funzione `showWithDissolve` visualizza un elemento canvas con una transizione di dissolvenza. This function has the following parameters:
...
La funzione `removeWithDissolve` rimuove un elemento canvas con una transizione di dissolvenza. This function has the following parameters:
...
La funzione `showWithFade` visualizza un elemento canvas con una transizione di dissolvenza. This function has the following parameters:
...
La funzione `removeWithFade` rimuove un elemento canvas con una transizione di dissolvenza. This function has the following parameters:
...
La funzione `moveIn` visualizza un elemento canvas con una transizione di spostamento. This function has the following parameters:
...
La funzione `moveOut` rimuove un elemento canvas con una transizione di spostamento. This function has the following parameters:
...
La funzione `pushIn` visualizza un elemento canvas con una transizione push-in. This function has the following parameters:
...
La funzione `pushOut` rimuove un elemento canvas con una transizione push-out. This function has the following parameters:
...
La funzione `zoomIn` visualizza un elemento canvas con una transizione di zoom-in. This function has the following parameters:
...
La funzione `zoomOut` rimuove un elemento canvas con una transizione di zoom-out. This function has the following parameters:
...
export default async function showWithDissolve(
    ...
    canvas.add(alias, component);
    oldComponent?.parent?.setChildIndex(oldComponent, oldComponent.parent.getChildIndex(oldComponent) - 0.1); // [!code ++]
