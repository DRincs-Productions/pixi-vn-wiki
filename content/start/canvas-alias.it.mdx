...
Questo è molto utile se vuoi eseguire alcune <DynamicLink href="/start/canvas-animations-effects">animazioni o effetti</DynamicLink> sull'interalo layer. Alcune funzionalità non sono consentite su questo elemento, come l'eliminazione.
