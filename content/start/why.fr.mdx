...
For a quick start, various <DynamicLink href="/start/getting-started#project-initialization">project templates</DynamicLink> are available. Less experienced developers can use these templates without much knowledge of JavaScript/TypeScript.
