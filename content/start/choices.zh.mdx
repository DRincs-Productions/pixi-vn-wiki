...
You can find the example of the choice menu UI screen in the <DynamicLink href="/start/interface-examples#choice-menu">interface examples</DynamicLink> section.
...
<Accordion title="Create a choice menu option" id="create-a-choice-menu-option">
...
<Accordion title="Create a close choice menu option" id="create-a-close-choice-menu-option">
