...
<Accordion title="Get already been made choices of current step" id="get-already-been-made-choices-of-current step">
...
<Accordion title="Check if current step is already been opened" id="check-if-current-step-is-already-been-opened">
