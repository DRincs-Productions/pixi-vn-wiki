...
icon: /react.svg
title: React UI
description: Cómo integrar Pixi’VN con React, incluyendo la configuración, las plantillas y las mejores bibliotecas de UI. Crear novelas visuales o juegos 2D con React.
---

Pixi’VN works great as a **visual novel React** engine, letting you build the UI of your visual novel or 2D game with React components while Pixi’VN handles the narration and canvas.

**¿Qué es React?** React es una biblioteca de JavaScript para crear interfaces de usuario (UI) para sitios web, aplicaciones y más. Es gratuita, de código abierto y está mantenida por Meta (anteriormente Facebook) y una gran comunidad.

Puedes obtener más información sobre React en el [React website](https://react.dev/).

## Cómo añadir Pixi’VN a una aplicación React

<Callout title="React template" type="info">

Existen plantillas de Pixi’VN que utilizan React. Puedes leer más sobre ellas en la sección <DynamicLink href="/start#project-initialization">templates</DynamicLink>.

Si deseas añadir Pixi’VN a una aplicación React existente, sigue los pasos a continuación.

</Callout>

Primero, necesitas una aplicación React y <DynamicLink href="/start#installation">instalar pixi-vn</DynamicLink>. Se recomienda utilizar [Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project) para crear una nueva aplicación React.

A continuación, puedes reemplazar el contenido de los siguientes archivos con el código de los ejemplos:
