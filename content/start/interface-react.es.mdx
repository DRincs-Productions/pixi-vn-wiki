...
icon: /react.svg
title: React UI
description: Cómo integrar Pixi’VN con React, incluyendo la configuración, las plantillas y las mejores bibliotecas de UI. Create a React visual novel or story-driven game.
---
