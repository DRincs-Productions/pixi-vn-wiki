...
Existen plantillas de Pixi’VN que utilizan React. Puedes leer más sobre ellas en la sección <DynamicLink href="/start#project-initialization">templates</DynamicLink>.If you want to add Pixi’VN to an existing React application, follow the steps below.
