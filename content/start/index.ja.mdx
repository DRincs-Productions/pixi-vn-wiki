...
Pixi’VNには、AIコーディングアシスタント（Claude Codeなど）にエンジンの各部分の正しい使い方を教える[Agent Skills](https://www.skills.sh/)一式が同梱されています。 Claude Codeを使用している場合は、次のコマンドですべてをプロジェクトにインストールできます。
