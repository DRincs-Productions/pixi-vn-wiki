...
Avant d’utiliser le moteur Pixi’VN, vous devez initialiser le jeu. You can do this by calling the [`Game.init`](/jsdoc/pixi-vn/index/namespaces/Game/functions/init) method.
