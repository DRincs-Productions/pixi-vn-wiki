...
- `options`: Équivalent aux options que vous pouvez utiliser lors de l’initialisation d’une application [PixiJS](https://pixijs.com/8.x/guides/basics#creating-an-application). Les options suivantes sont obligatoires :
