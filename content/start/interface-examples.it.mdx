...
<template>
    <div
        style="position: absolute; display: flex; flex-direction: column; height: 100%; width: 100%;"
    >
        ...
        >
            <b v-if="character && (character.name || character.surname)"
                >{{ character?.name || "" }} {{ character?.surname || "" }}</b
            >
            <div
                style="display: flex; flex-direction: row; height: 100%; min-height: 0; overflow: hidden;"
            >
                <img
                ...
                />
                <div
                    style="flex: 1; min-height: 0; overflow: auto; height: 100%;"
                >
...
export function useQueryDialogue() {
    return useQuery({
        ...
        queryFn: async ({ queryKey }) => {
            ...
            let character = dialogue?.character as
                | string
                | CharacterBaseModel
                | undefined;
...
<Accordion title="Pulsante 'successivo'" id="go-next">
...
export function useQueryCanGoNext() {
    return useQuery({
        ...
        queryFn: async () =>
            narration.canContinue && !narration.isRequiredInput,
    });
}
```
...
<template>
    <dialog :open="open" style="pointer-events: auto;">
        <p>{{ text }}</p>
        <input v-if="open" :value="currentValue || ''" @input="onInput" />
...
<Accordion title="Schermata dell'UI della storia" id="storia">
            ...
            >
                <div style="display:flex;gap:12px;align-items:center;">
                    <img
                        ...
                        loading="lazy"
                        alt=""
                        style="vertical-align:middle;max-width:50px;max-height:50px;border-radius:50%;"
                    />
                    <div style="flex:1;">
                ...
                <div style="display:flex;gap:8px;margin-top:8px;">
                    <div style="flex:1;">
                        ...
                        <div v-if="item.inputValue" :style="inputStyle">
