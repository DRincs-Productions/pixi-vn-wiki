...
Puoi trovare maggiori informazioni su come aggiungere componenti canvas in <DynamicLink href="/start/canvas-components">questa documentazione</DynamicLink> (<DynamicLink href="/ink/ink-canvas">Utilizza componenti canvas in _ink_</DynamicLink>).
