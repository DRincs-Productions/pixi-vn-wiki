...
Dopodiché potremo scrivere i <DynamicLink href="/start/dialogue">dialoghi</DynamicLink> che seguiranno nella nostra visual novel. Il template che abbiamo scelto supporta il <DynamicLink href="/start/markup-markdown">linguaggio di markup markdown</DynamicLink> (<DynamicLink href="/ink/ink-markup">Linguaggio di markup in _ink_</DynamicLink>), quindi lo useremo per la nostra narrazione.
...
Per fare ciò, chiederò al giocatore di <DynamicLink href="/start/input">completare una casella di input utilizzando le funzionalità di Pixi’VN</DynamicLink> (<DynamicLink href="/ink/ink-input">Utilizzare il prompt di input in _ink_</DynamicLink>).
