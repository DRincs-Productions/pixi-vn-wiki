...
Now I can call this label `animation_01` from the main label `start`. (As explained <DynamicLink href="/ink/ink-label#use-the-call-script">here</DynamicLink> from _ink_ I can call labels written in ts and vice versa.)
