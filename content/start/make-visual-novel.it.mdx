...
Per rendere più dinamica la visual novel, è possibile utilizzare le animazioni. For more information about how to use animations, see <DynamicLink href="/start/canvas-animations-effects">here</DynamicLink>.
...
In this example, my animation will take `steph` out of the scene and reinsert her in the next `step`. La specchierò anche sull'asse x per assicurarmi che sia rivolta nella direzione giusta.
