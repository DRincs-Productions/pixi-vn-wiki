...
const startLabel = newLabel("start", [
    async () => {
        narration.dialogue = `<span class="inline-block motion-translate-y-loop-25">Hello</span>, welcome to the game!`;
    },
]);
export default startLabel;
```

<iframe src="https://play.tailwindcss.com/WCoOH2CSuZ?layout=preview"
