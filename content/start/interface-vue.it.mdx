...
icon: /vue.svg
title: Vue UI
description: Come integrare Pixi'VN con Vue, inclusi configurazione, modelli ed esempi di interfaccia utente.
---
...
I am looking for someone to help me develop Vue templates. Sei disponibile ad aiutare?
...
Per prima cosa, hai bisogno di un'applicazione Vue e di <DynamicLink href="/start/getting-started#installation">installare pixi-vn</DynamicLink>. Si consiglia di utilizzare [Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project) per creare una nuova applicazione Vue.
