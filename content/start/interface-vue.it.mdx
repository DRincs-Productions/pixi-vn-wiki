...
icon: /vue.svg
title: Vue UI
description: Come integrare Pixi'VN con Vue, inclusi configurazione, modelli ed esempi di interfaccia utente. Create a Vue visual novel or story-driven game.
---
