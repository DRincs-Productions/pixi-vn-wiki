...
**Cos'è Vue?** Vue è un framework progressivo per la creazione di interfacce utente. It is designed to be incrementally adoptable and can easily scale between a library and a full-featured framework.
...
Sto cerco qualcuno che mi aiuti a sviluppare i template di Vue. Are you available to help?
...
First, you need a Vue application and to <DynamicLink href="/start/getting-started#installation">install pixi-vn</DynamicLink>. It is recommended to use [Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project) to create a new Vue application.
