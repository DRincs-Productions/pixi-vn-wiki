...
**Cos'è Vue?** Vue è un framework progressivo per la creazione di interfacce utente. È progettato fin dalle fondamenta per essere adottabile in modo incrementale e può essere facilmente scalato tra una libreria e un framework.

Puoi scoprire di più su Vue sul [sito web di Vue](https://vuejs.org/).

## Come aggiungere Pixi’VN a un’applicazione Vue

<Callout title="Vue template" type="info">
Sto cerco qualcuno che mi aiuti a sviluppare i template di Vue. Sei disponibile ad aiutarmi?

Puoi seguire lo sviluppo e mostrare il tuo interesse nel seguente thread [discussion#432](https://github.com/DRincs-Productions/pixi-vn/discussions/432).

</Callout>

Prima di tutto devi avere un'applicazione Vue e <DynamicLink href="/start/getting-started#installation">installare pixi-vn</DynamicLink>. Si consiglia di utilizzare [Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project) per creare una nuova applicazione Vue.
