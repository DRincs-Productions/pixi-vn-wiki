...
First, you need a Vue application and to <DynamicLink href="/start#installation">install pixi-vn</DynamicLink>. Si consiglia di utilizzare [Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project) per creare una nuova applicazione Vue.
