...
Per prima cosa, hai bisogno di un'applicazione Vue e di <DynamicLink href="/start/getting-started#installation">installare pixi-vn</DynamicLink>. Is recommended to use [Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project) to create a new Vue application.
