...
To set a temporary variable, use `storage.setTempVariable`. Эта функция принимает следующие параметры:
...
To remove a temporary variable, use `storage.removeTempVariable`. Эта функция принимает следующие параметры:
