...
Es gibt Pixi’VN-Vorlagen, die React verwenden. Mehr darüber erfährst du im Abschnitt <DynamicLink href="/start#project-initialization">Vorlagen</DynamicLink>.If you want to add Pixi’VN to an existing React application, follow the steps below.
