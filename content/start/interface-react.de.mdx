---
title: React-UI
description: So integrierst du Pixi’VN mit React, einschließlich Einrichtung, Vorlagen und den besten UI-Bibliotheken. Erstelle eine Visual Novel oder ein erzählgetriebenes Spiel mit React.
---
...
Mehr über React erfährst du auf der [React-Website](https://react.dev/).

## So fügst du Pixi’VN einer React-Anwendung hinzu

:::tip[Vorlagen]

Es gibt Pixi’VN-Vorlagen, die React verwenden. Mehr darüber erfährst du im Abschnitt <DynamicLink href="/start#project-initialization">Vorlagen</DynamicLink>.Wenn du Pixi’VN einer bestehenden React-Anwendung hinzufügen möchtest, folge den unten stehenden Schritten.

Wenn du Pixi’VN einer bestehenden React-Anwendung hinzufügen möchtest, folge den unten stehenden Schritten.

:::

Zuerst benötigst du eine React-Anwendung und musst <DynamicLink href="/start#installation">pixi-vn installieren</DynamicLink>. Es wird empfohlen, [Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project) zu verwenden, um eine neue React-Anwendung zu erstellen.
