...
To load and manipulate assets (images, gifs, videos...) zu laden und zu verarbeiten, müssen Sie `Assets` verwenden. `Assets` is a class with many features and comes from the PixiJS library, if you want more information read [here](https://pixijs.com/8.x/guides/components/assets).
