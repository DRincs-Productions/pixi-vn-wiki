...
Compared to the `Container` component, [`ImageContainer`](/jsdoc/pixi-vn/index/classes/ImageContainer) adds the following features:
...
This function returns an [`ImageContainer`](/jsdoc/pixi-vn/index/classes/ImageContainer) that you can use to manipulate the component. This function has the following parameters:
