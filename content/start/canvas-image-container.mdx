...
The `ImageContainer` component extends the [`PixiJS.Container`](https://pixijs.com/8.x/guides/components/containers) component, so you can use all the methods and properties of `Container`. It allows you to group multiple images into a single component and manipulate them as one.
