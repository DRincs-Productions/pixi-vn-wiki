---
title: Vue UI
description: Как интегрировать Pixi’VN с Vue, включая настройку, шаблоны и примеры UI. Создайте visual novel или сюжетную игру на Vue.
---
...
Подробнее о Vue можно узнать на [сайте Vue](https://vuejs.org/).
...
Сначала вам понадобится приложение Vue и нужно <DynamicLink href="/start#installation">установить pixi-vn</DynamicLink>. Рекомендуется использовать [Vite](https://vite.dev/guide/#scaffolding-your-first-vite-project) для создания нового приложения Vue.
