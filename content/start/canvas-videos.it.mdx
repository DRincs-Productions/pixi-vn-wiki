...
- `videoUrl` (Opzionale): L'URL o il percorso. If you have initialized the <DynamicLink href="/start/assets-management#initialize-the-asset-matrix-at-project-start">asset matrix</DynamicLink>, you can use the alias of the texture.
...
- `videoUrl` (Opzionale): L'URL o il percorso. If you have initialized the <DynamicLink href="/start/assets-management#initialize-the-asset-matrix-at-project-start">asset matrix</DynamicLink>, you can use the alias of the texture. Se non si specifica l'URL, verrà utilizzato l'alias come URL.
- `options` (Opzionale): Le opzioni per il componente.
