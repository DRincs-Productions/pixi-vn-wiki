...
- `videoUrl` (Optional): The URL or path of the video. Se hai inizializzato la <DynamicLink href="/start/assets-management#initialize-the-asset-matrix-at-project-start">matrice delle risorse</DynamicLink>, puoi utilizzare l'alias della texture. Se non si specifica l'URL, verrà utilizzato l'alias come URL.
- `options` (Opzionale): Le opzioni per il componente.
