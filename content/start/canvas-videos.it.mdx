...
- `videoUrl` (Optional): The URL or path of the video. Se hai inizializzato la <DynamicLink href="/start/assets-management#initialize-the-asset-matrix-at-project-start">matrice delle risorse</DynamicLink>, puoi utilizzare l'alias della texture.
...
The simplest and fastest method to show an video on the canvas is to use the `showVideo` function. Questa funzione è una combinazione delle funzioni `load` e <DynamicLink href="/start/canvas-functions#add-a-canvas-component">`canvas.add`</DynamicLink>.
...
- `videoUrl` (Optional): The URL or path of the video. Se hai inizializzato la <DynamicLink href="/start/assets-management#initialize-the-asset-matrix-at-project-start">matrice delle risorse</DynamicLink>, puoi utilizzare l'alias della texture. If you don't provide the URL, then the alias is used as the URL.
- `options` (Opzionale): Le opzioni per il componente.
