...
To set a variable in the game storage, use `storage.set`. Questa funzione ha i seguenti parametri:
...
To get a variable from the game storage, use `storage.get`. Questa funzione ha i seguenti parametri:
