...
Per impostare una variabile nell'archivio di gioco, puoi usare `storage.setVariable`. Questa funzione ha i seguenti parametri:
...
Per ottenere una variabile dall'archivio del gioco, puoi usare `storage.getVariable`. Questa funzione ha i seguenti parametri:
...
Per rimuovere una variabile dall'archivio del gioco, puoi usare `storage.removeVariable`. Questa funzione ha i seguenti parametri:
...
Per impostare una variabile temporanea, è possibile utilizzare `storage.setTempVariable`. Questa funzione ha i seguenti parametri:
...
Per ottenere una variabile temporanea, puoi usare la normale funzione [`storage.getVariable`](#get).

**Rimuovi una variabile temporanea**:

Per rimuovere una variabile temporanea, è possibile utilizzare `storage.removeTempVariable`. Questa funzione ha i seguenti parametri:
