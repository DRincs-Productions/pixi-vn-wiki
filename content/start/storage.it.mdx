...
Per impostare una variabile nell'archivio di gioco, utilizzare `storage.set`. This function has the following parameters:
...
Per ottenere una variabile dall'archivio del gioco, utilizzare `storage.get`. This function has the following parameters:
...
Per rimuovere una variabile dall'archivio del gioco, utilizzare `storage.remove`. This function has the following parameters:
