...
Taking into account that a storage variables can only be changed during a <DynamicLink href="/start/labels#next-step-and-go-back">next step, go back</DynamicLink>, <DynamicLink href="/start/labels#run-a-label">run label</DynamicLink> or <DynamicLink href="/start/save#load">loading a save</DynamicLink> (outside the interface), we will create a `useQueryText1` and `useQueryText2` that will be updated after each <DynamicLink href="/start/labels#next-step-and-go-back">next step, go back</DynamicLink>, <DynamicLink href="/start/labels#run-a-label">run label</DynamicLink> or <DynamicLink href="/start/save#load">loading a save</DynamicLink>.
