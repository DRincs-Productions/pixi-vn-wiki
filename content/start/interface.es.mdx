...
To add an HTML UI Layer, you can use the `canvas.addHtmlLayer` function. Esta función tiene los siguientes parámetros:
...
To get the HTML element of the layer, you can use the `canvas.getHtmlLayer` function. Esta función tiene los siguientes parámetros:

- `id`: The id of the layer.

To remove an HTML UI Layer, you can use the `canvas.removeHtmlLayer` function. Esta función tiene los siguientes parámetros:
...
To add a PixiJS UI Layer, you can use the `canvas.addLayer` function. Esta función tiene los siguientes parámetros:
...
To get the PixiJS Container of the layer, you can use the `canvas.getLayer` function. Esta función tiene los siguientes parámetros:

- `label`: The PixiJS Container label.

To remove a PixiJS UI Layer, you can use the `canvas.removeLayer` function. Esta función tiene los siguientes parámetros:
