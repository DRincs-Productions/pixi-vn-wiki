...
It is recommended to name each bundle based on **where it will be used**. Ad esempio:
...
Puoi usare questo metodo con la sintassi *ink*. See more <DynamicLink href="/ink/assets">here</DynamicLink>.
