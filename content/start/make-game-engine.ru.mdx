...
The first `step` is to create a new project. Более подробную информацию о создании проекта на основе шаблона можно найти <DynamicLink href="/start#project-initialization">здесь</DynamicLink>. The "Game Engine" template is a simple project that contains the basic structure of a game engine. By default, it exports the basic functionality of pixi-vn while removing anything unused from the package.
