...
The simplest way to show a video on the canvas is to use the [`showVideo`](/jsdoc/pixi-vn/index/functions/showVideo) function. Эта функция объединяет [`load`](/jsdoc/pixi-vn/index/classes/ImageSprite#load) и [`canvas.add`](/jsdoc/pixi-vn/index/interfaces/CanvasManagerInterface#add).
