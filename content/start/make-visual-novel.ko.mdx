...
To load and manipulate assets (images, gifs, videos...) 을 로드하고 조작하려면 `Assets`를 사용해야 합니다. `Assets` is a class with many features and comes from the PixiJS library, if you want more information read [here](https://pixijs.com/8.x/guides/components/assets).
