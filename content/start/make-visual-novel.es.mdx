...
Para cargar y manipular assets (imágenes, Gif, vídeos, etc...) you will need to use `Assets`. `Assets` es una clase con muchas funcionalidades y proviene de la biblioteca PixiJS. Si deseas más información, lee [aquí](https://pixijs.com/8.x/guides/components/assets).
