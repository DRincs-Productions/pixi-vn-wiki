...
<Cards>
    <DynamicLink className="@max-lg:col-span-full" href="/start/distribution-website">
    ...
    <DynamicLink className="@max-lg:col-span-full" href="/start/distribution-itchio">
        <Card title="itch.io">
            Upload your game to itch.io and make it playable in the browser.
        </Card>
    </DynamicLink>
    <DynamicLink className="@max-lg:col-span-full" href="/start/distribution-reddit">
        <Card title="Reddit">
            Distribute your game on Reddit.
        </Card>
    </DynamicLink>
    <DynamicLink className="@max-lg:col-span-full" href="/start/distribution-desktop-mobile">
        <Card title="Desktop & Mobile devices">
            Wrap your game with Tauri to ship lightweight native desktop and mobile builds.
        </Card>
    </DynamicLink>
    <DynamicLink className="@max-lg:col-span-full" href="/start/distribution-steam">
        <Card title="Steam">
