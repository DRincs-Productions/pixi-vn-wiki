...
The `showWithDissolve` function displays a canvas element with a dissolve transition. この関数は以下のパラメータを持ちます：
...
The `removeWithDissolve` function removes a canvas element with a dissolve transition. この関数は以下のパラメータを持ちます：
...
The `showWithFade` function displays a canvas element with a fade transition. この関数は以下のパラメータを持ちます：
...
The `removeWithFade` function removes a canvas element with a fade transition. この関数は以下のパラメータを持ちます：
...
The `moveIn` function displays a canvas element with a move-in transition. この関数は以下のパラメータを持ちます：
...
The `moveOut` function removes a canvas element with a move-out transition. この関数は以下のパラメータを持ちます：
...
The `pushIn` function displays a canvas element with a push-in transition. この関数は以下のパラメータを持ちます：
...
The `pushOut` function removes a canvas element with a push-out transition. この関数は以下のパラメータを持ちます：
...
The `zoomIn` function displays a canvas element with a zoom-in transition. この関数は以下のパラメータを持ちます：
...
The `zoomOut` function removes a canvas element with a zoom-out transition. この関数は以下のパラメータを持ちます：
