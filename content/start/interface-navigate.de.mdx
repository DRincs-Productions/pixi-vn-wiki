...
In all ink templates, a <DynamicLink href="/ink/hashtag">custom hashtag script</DynamicLink> has been introduced to navigate between routes. To do this, you need to use the following syntax:
