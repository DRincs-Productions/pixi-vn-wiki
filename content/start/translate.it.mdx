...
In visual novels and similar games, it is common to allow players to select their preferred language.
...
In Pixi’VN projects, you often need to translate narration text in TypeScript/JavaScript <DynamicLink href="/start/labels">`labels`</DynamicLink>. To enable this, the translation function is included in the <DynamicLink href="/start/labels#steplabelprops">`StepLabelProps` interface</DynamicLink>.
...
## Create the JSON file for translations

<Callout title="ink" type="info">

If you use ink, you can automatically extract strings from ink text into the JSON file for translation. Read more <DynamicLink href="/ink/ink-translate">here</DynamicLink>.
