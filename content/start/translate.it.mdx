...
Nei progetti Pixi'VN, spesso è necessario tradurre il testo della narrazione nelle <DynamicLink href="/start/labels">`labels`</DynamicLink> TypeScript/JavaScript. To enable this, the translation function must be in the <DynamicLink href="/start/labels#steplabelprops">`StepLabelProps` interface</DynamicLink>.
...
If you use ink, you can automatically extract strings from ink text for translation. See more <DynamicLink href="/ink/ink-translate">here</DynamicLink>.
