...
The **_ink_ + Pixi’VN integration** introduces a `# script` that allows you to show, edit, remove and etc. a <DynamicLink href="/start/canvas-components">canvas component</DynamicLink>. Per fare ciò, è necessario utilizzare la seguente sintassi:
