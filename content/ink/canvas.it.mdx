...
Is raccomended to <DynamicLink href="/start/assets-management#initialize-the-asset-matrix-at-project-start">initialize the asset matrix at project start</DynamicLink> to use the alias of texture in `[URL/path of the image]`. Per fare ciò, è necessario utilizzare la seguente sintassi:
