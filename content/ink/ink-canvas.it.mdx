...
The **_ink_ + Pixi’VN integration** introduces the a # script that allows you to show, edit, remove and etc. a [canvas component](/start/canvas-components).
...
- `[list of URL/path of the image]`: It is the list of URL/path of the images that you want to show. Se hai inizializzato la [matrice delle risorse](/start/assets-management#initialize-the-asset-matrix-at-project-start), puoi utilizzare l'alias della texture. Tieni presente che per scrivere `https://` in **_ink_** devi usare `https:\/\/` perché `//` è considerato un commento in **_ink_**.
...
- `dissolve`: The canvas component appears with a [dissolve transition](/start/canvas-transition#dissolve-transition). You can add all the parameters you would use in JS/TS.
- `fade`: The canvas component appears with a [fade transition](/start/canvas-transition#fade-transition). You can add all the parameters you would use in JS/TS.
- `movein`: The canvas component appears with a [movein transition](/start/canvas-transition#move-inout-transition). You can add all the parameters you would use in JS/TS.
- `zoomin`: The canvas component appears with a [zoomin transition](/start/canvas-transition#zoom-inout-transition). You can add all the parameters you would use in JS/TS.
- `pushin`: The canvas component appears with a [pushin transition](/start/canvas-transition#push-inout-transition). You can add all the parameters you would use in JS/TS.
...
You can use the `edit` to edit a [canvas component](/start/canvas-components) in **_ink_**.
...
You can use the `remove` to remove a [canvas component](/start/canvas-components) in **_ink_**.
...
- `dissolve`: The canvas component disappears with a [dissolve transition](/start/canvas-transition#dissolve-transition). You can add all the parameters you would use in JS/TS.
- `fade`: The canvas component disappears with a [fade transition](/start/canvas-transition#fade-transition). You can add all the parameters you would use in JS/TS.
- `moveout`: The canvas component disappears with a [moveout transition](/start/canvas-transition#move-inout-transition). You can add all the parameters you would use in JS/TS.
- `zoomout`: The canvas component disappears with a [zoomout transition](/start/canvas-transition#zoom-inout-transition). You can add all the parameters you would use in JS/TS.
- `pushout`: The canvas component disappears with a [pushout transition](/start/canvas-transition#push-inout-transition). You can add all the parameters you would use in JS/TS.
...
You can use the `[effectType]` to use the [effects](/start/canvas-animations-effects) in **_ink_**.
...
- `fade`: Create a fade effect. (Read more [here](/start/canvas-animations-effects#fade)). You can add all the parameters you would use in JS/TS.
- `move`: Create a move effect. (Read more [here](/start/canvas-animations-effects#move)). You can add all the parameters you would use in JS/TS. To simplify the use:
...
- `rotate`: Create a rotate effect. (Read more [here](/start/canvas-animations-effects#rotate)). You can add all the parameters you would use in JS/TS.
- `zoom`: Create a zoom effect. (Read more [here](/start/canvas-animations-effects#zoom)). You can add all the parameters you would use in JS/TS.
- `shake`: Create a shake effect. (Read more [here](/start/canvas-animations-effects#shake)). You can add all the parameters you would use in JS/TS.
...
To pause a video in **_ink_**, you can use `pause`.
...
To resume a video in **_ink_**, you can use `resume`.
