...
In the Pixi’VN library, a knot corresponds to a <DynamicLink href="/start/labels#label">label</DynamicLink>. The **_ink_ + Pixi’VN integration**, in addition to giving the possibility to run **_ink_ nodes**, also allows you to call knots (or labels) written in another <DynamicLink href="/start/narration">narrative language or Javascript/TypeScript</DynamicLink>.
