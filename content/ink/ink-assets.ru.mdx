...
/**
 * Манифест для активов, используемых в игре.
 * Подробнее о манифесте можно прочитать здесь: https://pixijs.com/8.x/guides/components/assets#loading-multiple-assets
 */
