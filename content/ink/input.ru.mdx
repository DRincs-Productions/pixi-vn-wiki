---
title: Use input prompt in ink
---

The **_ink_ + Pixi’VN integration** introduces the a # script that allows you to request an <DynamicLink href="/start/input">input prompt</DynamicLink> from the user.
