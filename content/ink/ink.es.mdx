...
The novice developers can use a <DynamicLink href="/start/getting-started#project-initialization">_ink_ template</DynamicLink> to start developing just with **_ink_**, and then gradually learn Javascript/Typescript to create more complex features.

## Start using _ink_ in Pixi’VN

If you have not created a project yet then it is recommended to use a <DynamicLink href="/start/getting-started#project-initialization">Pixi’VN + _ink_ template</DynamicLink> to start developing with **_ink_**.
...
Now you can run the **_ink_ knot** (or label) with <DynamicLink href="/start/labels#run-a-label">Pixi’VN functions</DynamicLink>.
