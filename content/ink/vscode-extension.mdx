...
description: |
  Ufficial VS Code extension for editing and live-testing ink scripts with Pixi’VN. Provides syntax highlighting, engine selection, and real-time preview for your narratives.
---
