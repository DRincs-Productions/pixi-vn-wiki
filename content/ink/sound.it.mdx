---
title: Use sounds and music in ink
---
...
To change the volume of a sound in **_ink_**, you can use the `volume` operation. Per fare ciò, è necessario utilizzare la seguente sintassi:
