...
The **_ink_ + Pixi’VN integration** introduces the a # script that allows you to show, edit, remove and etc. a <DynamicLink href="/start/canvas-components">canvas component</DynamicLink>.
...
- `#`: Это специальный символ, используемый **_ink_ синтаксисом** для использования специального скрипта.
...
You can use the `edit` to edit a <DynamicLink href="/start/canvas-components">canvas component</DynamicLink> in **_ink_**.
...
You can use the `remove` to remove a <DynamicLink href="/start/canvas-components">canvas component</DynamicLink> in **_ink_**.
...
You can use the `animate` to use the <DynamicLink href="/start/canvas-motion">animations</DynamicLink> in **_ink_**.
