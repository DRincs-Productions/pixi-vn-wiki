...
In all templates, you can use the following button ![dowload-translate](/dowload-translate.png) in the settings to automatically generate the json file that will be used for translations.
