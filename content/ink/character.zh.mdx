...
Having the ability to rename a character and use their name in dialogues greatly simplifies the development of a Visual Novel. Since the <DynamicLink href="/start/character">character</DynamicLink> is an object based on a <DynamicLink href="/start/character#custom-class">customizable model</DynamicLink>, it is not possible to use the character as a <DynamicLink href="/ink/variables">variable</DynamicLink> simply with the `{}` syntax.

But you can take advantage of the <DynamicLink href="/ink/replacement">possibility of replacing portions of text</DynamicLink> and <DynamicLink href="/ink/hashtag">customizing hashtag scripts</DynamicLink> to implement this feature.
