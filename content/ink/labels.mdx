...
No, they are the same thing. In Pixi’VN, when you create a `knot` with **_ink_**, a `label` will be created internally and saved in the registry.
...
<PixiVnExample path="ink/narration/jump" ink />
...
<PixiVnExample path="ink/narration/call" ink />
