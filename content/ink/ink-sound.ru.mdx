...
The **_ink_ + Pixi’VN integration** introduces the a # script that allows you to use the <DynamicLink href="/start/sound">sounds and music</DynamicLink>.
...
You can use the `play` to play a sound in **_ink_**.
...
To pause a sound in **_ink_**, you can use the `pause` operation.
...
To resume a sound in **_ink_**, you can use the `resume` operation.
...
To remove a sound in **_ink_**, you can use the `stop` operation.
...
To change the volume of a sound in **_ink_**, you can use the `volume` operation.
