...
The ***ink* + Pixi’VN integration** introduces a # script that allows you to show, edit, remove and etc. a <DynamicLink href="/start/canvas-components">canvas component</DynamicLink>.
...
You can use the `animate` to use the <DynamicLink href="/start/canvas-motion">animations</DynamicLink> in ***ink***.
