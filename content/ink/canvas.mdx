...
`#` + `show` + `[component type]` + `[alias]` + `[URL/path of the image]` + `[parameters]`
...
`#` + `show` + `[component type]` + `[alias]` + `[URL/path of the image]` + `[parameters]` + `with` + `[transitionType]`
...
`#` + `show` + `[component type]` + `[alias]` + `[URL/path of the image]` + `[parameters]` + `with` + `[transitionType]` + `[transition parameters]`
