...
description: Créez des récits interactifs en utilisant ink, un langage de script conçu pour les histoires à embranchements, intégré à Pixi’VN.
---
...
- Étant donné que « Threads » ne sont pas pris en charge par pixi-vn, le symbole `<-` correspond à <DynamicLink href="/ink/labels#call">l’appel d’un knot</DynamicLink>.
