...
Having the ability to rename a character and use their name in dialogues greatly simplifies the development of a Visual Novel. Since the <DynamicLink href="/start/character">character</DynamicLink> is an object based on a <DynamicLink href="/start/character#custom-character">customizable model</DynamicLink>, it is not possible to use the character as a <DynamicLink href="/ink/ink-variables">variable</DynamicLink> simply with the `{}` syntax.
