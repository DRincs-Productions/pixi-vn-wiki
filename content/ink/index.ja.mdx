...
description: |
  Learn how to create your own game with the ink scripting language and the Pixi’VN game engine. Write interactive narratives, import ink files, and use advanced features in your visual novel projects.
---
...
- [`Threads`](https://github.com/inkle/ink/blob/master/Documentation/WritingWithInk.md#2-threads) ([#39](https://github.com/DRincs-Productions/pixi-vn-ink/issues/39))
