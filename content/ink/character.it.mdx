...
Per utilizzare il nome del personaggio nei dialoghi, puoi sfruttare la <DynamicLink href="/ink/replacement">possibilità di sostituire parti di testo</DynamicLink>. For example, you can use the following method:
...
You can edit a character's information in **_ink_**, for example, you can change the character's name. Per fare ciò, è necessario utilizzare la seguente sintassi:
...
Utilizzando la possibilità di <DynamicLink href="/ink/hashtag">personalizzare gli script degli hashtag</DynamicLink>. For example, you can use the following method:
