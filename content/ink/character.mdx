...
You can use the <DynamicLink href="/start/character#character-emotions">character emotions</DynamicLink> in **_ink_**. To do this you just need to use a special ID composed of the character id, the `@` separator, and the emotion:
