...
To pause a sound or a channel in **_ink_**, you can use the `pause` operation. To do this, you need to use the following syntax:

```ink title="ink"
# pause {component type} {alias}
```

To resume a sound or a channel in **_ink_**, you can use the `resume` operation. To do this, you need to use the following syntax:
