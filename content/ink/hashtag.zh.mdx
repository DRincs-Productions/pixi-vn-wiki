...
**_ink_** gives the ability to use the `#` character to define custom hashtag commands (or _tags_). Pixi’VN uses this feature to add custom functionality to the ink script, for example, to interact with the canvas.
