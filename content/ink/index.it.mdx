...
description: |
  Scopri come creare il tuo gioco con il linguaggio di scripting ink e il motore di gioco Pixi'VN. Write interactive narratives, import ink files, and use advanced features in your projects.
---
...
`INCLUDE` is an _ink_ statement to include another _ink_ file. In Pixi'VN, dovresti usare `importInkText()` per caricare più file _ink_, quindi `INCLUDE` viene ignorato.
