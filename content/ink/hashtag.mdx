...
***ink*** gives the ability to use the `#` character to define custom hashtag scripts (or *tags*). Pixi’VN uses this feature to add custom functionality to the ink script, for example, to interact with the canvas.
