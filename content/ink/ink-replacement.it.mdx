---
title: Replace portions of text in ink
---
...
You can override the function `onReplaceTextBeforeTranslation` to add a script that can be interpreted by the <DynamicLink href="/ink/ink-translate">translation library</DynamicLink> used (for example [i18next](https://www.i18next.com/)).
