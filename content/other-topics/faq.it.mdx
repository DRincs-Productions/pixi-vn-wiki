...
<Accordion title="How enable the decorators in TypeScript?">
...
<Accordion title="How use navigation function in step/label?">
...
<Accordion title="Skip step and Auto Forward">
...
<Accordion title="How to link a character to an image to add to the canvas?">
...
To do this, you just need to create a <DynamicLink href="/start/character#custom-character">custom character</DynamicLink> or modify the existing one (it is already present in the templates).
