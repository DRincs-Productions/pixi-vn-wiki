...
To initialize the time system, you need use the `initialize` method of the `timeTracker` instance. Esta función tiene los siguientes parámetros:
...
To increment the current `date` by a specific amount, use the `increaseDate` method. Esta función tiene los siguientes parámetros:
