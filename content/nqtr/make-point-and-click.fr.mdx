...
La première étape consiste à créer un nouveau projet. Vous pouvez trouver plus d’informations sur la création d’un projet à partir d’un modèle <DynamicLink href="/start#project-initialization">ici</DynamicLink>. We will use the template "Point & Click Adventure - React".
