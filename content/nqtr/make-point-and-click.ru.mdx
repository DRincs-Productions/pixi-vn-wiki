...
Первый шаг — создать новый проект. Более подробную информацию о создании проекта на основе шаблона можно найти <DynamicLink href="/start#project-initialization">здесь</DynamicLink>. We will use the template "Point & Click Adventure - React".
