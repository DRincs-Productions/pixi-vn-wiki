...
正在开始一个新的 Pixi’VN 项目？ Use a <DynamicLink href="/start#project-initialization">template</DynamicLink> that already includes NQTR.
...
To access NQTR features you can add a handler to _ink_'s hashtag commands.
