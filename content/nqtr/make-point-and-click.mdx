...
Di solito è possibile definire un elemento grafico come una stringa che rappresenta il nome dell'asset. Il template da anche la possibilita usare la classe <DynamicLink href="/start#interface-pixijs">`TimeSlotsImage`<DynamicLink href="/start#interface-react">
