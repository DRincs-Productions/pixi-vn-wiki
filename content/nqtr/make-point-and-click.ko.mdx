...
첫 번째 단계는 새 프로젝트를 만드는 것입니다. You can find more information on how to create a new project starting from a template <DynamicLink href="/start#project-initialization">here</DynamicLink>. We will use the template "Point & Click Adventure - React".
