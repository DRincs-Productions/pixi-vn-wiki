...
El primer paso es crear un nuevo proyecto. Puedes encontrar más información sobre cómo crear un proyecto a partir de una plantilla <DynamicLink href="/start#project-initialization">aquí</DynamicLink>. We will use the template "Point & Click Adventure - React".
