...
You can also add a task to your routine during gameplay. This feature is useful if you want to temporarily add a task. The list of tasks added this way will be included in your game saves.

To add a task to your routine during gameplay, you can use the `routine.add` method.
