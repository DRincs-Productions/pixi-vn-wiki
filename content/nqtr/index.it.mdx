...
If you are starting a new Pixi'VN project, it is recommended to use one of the <DynamicLink href="/start#project-initialization">templates</DynamicLink> that already include NQTR.
...
<Accordion title="Overriding OnRunProps" id="onrunprops">
