...
**Are migrations required?** No code changes are required. However, please note that the internal structure of **pixi-vn** has changed, so you may want to review your project setup if you rely on its internal layout.
