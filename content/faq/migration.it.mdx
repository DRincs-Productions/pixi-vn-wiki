...
La prima modifica introdotta consiste nel fatto che i layout HTML utilizzano ora `userSelect: "none"` come valore predefinito (quindi il testo non è selezionabile). This was done to prevent issues with text selection during UI interactions. If you want to make text selectable, you can simply override this property with `userSelect: "auto"`.
