...
### Migration from v1.9.4 to v1.9.5 — canvas transitions and effects namespaces

Version **1.9.5 is not released yet**. The changes below describe the upcoming release.
