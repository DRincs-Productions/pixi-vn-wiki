...
<Accordion title="如何启用 TypeScript 中的装饰器？" id="enable-typescript-decorators">
...
<Accordion title="Skip `steps` and auto forward" id="skip-auto">
...
<Accordion title="How to link a character to an image to add to the canvas?" id="link-character-to-image">
...
<Accordion title="键盘快捷键（热键）" id="hotkeys">
