...
const variants = {
    primary:
        "bg-fd-primary text-fd-primary-foreground hover:bg-fd-primary/80 hover:shadow-[0_0_20px_-4px_var(--color-brand-secondary)] disabled:bg-fd-secondary disabled:text-fd-secondary-foreground",
