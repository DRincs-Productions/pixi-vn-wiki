...
export function KofiIcon(props: SVGProps<SVGSVGElement>): React.ReactElement {
    return (
        <svg
            aria-label="Ko-fi"
            xmlns="http://www.w3.org/2000/svg"
...
export function KofiLogo(props: SVGProps<SVGSVGElement>): React.ReactElement {
    return (
        <svg
            aria-label="Ko-fi"
            xmlns="http://www.w3.org/2000/svg"
        ...
        >
            <g clipPath="url(#clip0_1_194)">
                ...
                >
                    <path
                        d="M737.178 0.299805H-0.00585938V200.865H737.178V0.299805Z"
                        fill="white"
                    />
                </mask>
                <g mask="url(#mask0_1_194)">
                    <path
                        d="M345.948 199.597C333.351 199.597 320.101 192.881 308.601 181.463C308.164 182.224 307.701 182.96 307.225 183.671C302.379 190.933 293.043 199.597 276.038 199.597C264.399 199.597 248.713 195.081 240.055 173.567C234.251 159.149 231.549 137.051 231.549 104.018C231.549 75.0379 234.892 51.931 241.482 35.3447C245.294 25.7418 250.299 18.1431 256.35 12.7581C263.454 6.44068 272.112 3.09801 281.378 3.09801C293.607 3.09801 304.098 8.61626 310.917 18.6378C311.957 20.1728 312.908 21.8029 313.764 23.5281C327.326 9.94188 341.121 3.09167 354.999 3.09167C373.279 3.09167 385.084 15.7202 385.084 35.2686C385.084 46.305 379.97 59.1174 369.879 73.3382C364.063 81.5328 356.826 89.9244 348.593 98.0242C363.72 120.871 377.649 149.261 377.649 167.179C377.649 175.844 374.402 183.963 368.496 190.039C362.515 196.198 354.504 199.591 345.935 199.591L345.948 199.597Z"
                        fill="white"
                    />
                    <path
                        d="M369.867 35.2693C369.867 25.9772 366.15 18.3151 355.006 18.3151C342.929 18.3151 325.049 26.9096 303.217 62.2069C303.914 58.0273 304.143 54.0757 304.143 50.3652C304.143 31.3178 296.246 18.3151 281.385 18.3151C258.855 18.3151 246.779 50.1306 246.779 104.013C246.779 167.187 256.762 184.369 276.044 184.369C292.301 184.369 300.66 173.218 301.593 144.657C313.207 169.971 332.019 184.369 345.954 184.369C355.012 184.369 362.446 176.935 362.446 167.18C362.446 152.782 347.813 121.893 328.537 95.8809C350.604 76.6051 369.879 51.7543 369.879 35.263L369.867 35.2693Z"
                        fill="white"
                    />
                    <path
                        d="M695.015 83.1239C672.151 83.1239 653.549 64.2412 653.549 41.0269C653.549 29.9206 657.78 19.6326 665.451 12.0593C673.142 4.47334 683.639 0.299805 695.015 0.299805C706.396 0.299805 717.069 4.44163 724.879 11.9578C732.811 19.5946 737.177 29.9967 737.177 41.2553C737.177 64.343 718.264 83.1239 695.015 83.1239Z"
                        fill="white"
                    />
                    <path
                        d="M695.016 67.9021C709.879 67.9021 721.954 55.8315 721.954 41.256C721.954 26.6802 710.578 15.5232 695.016 15.5232C679.458 15.5232 668.769 26.6802 668.769 41.0275C668.769 55.375 680.384 67.9021 695.016 67.9021Z"
                        fill="white"
                    />
                    <path
                        d="M691.999 200.862C677.025 200.862 664.762 193.416 657.486 179.906C651.558 168.888 648.67 153.627 648.67 133.261C648.67 112.894 651.569 97.6587 657.532 86.6412C664.935 72.9599 677.505 65.4249 692.924 65.4249C708.344 65.4249 719.501 72.0784 726.574 84.6623C732.54 95.2801 735.32 110.141 735.32 131.434C735.32 152.727 732.498 168.349 726.689 179.493C719.509 193.27 707.184 200.862 691.999 200.862Z"
                        fill="white"
                    />
                    <path
                        d="M692.924 80.6542C672.951 80.6542 663.894 98.4203 663.894 133.261C663.894 168.102 673.185 185.64 691.999 185.64C710.812 185.64 720.104 168.559 720.104 131.441C720.104 94.3228 711.047 80.6542 692.932 80.6542H692.924Z"
                        fill="white"
                    />
                    <path
            ...
            <defs>
                <clipPath id="clip0_1_194">
                    <rect
                        ...
                        height="200.806"
                        fill="white"
                        transform="translate(-0.00585938 0.299805)"
                    />
                </clipPath>
            </defs>
        </svg>
