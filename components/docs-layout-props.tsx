    ...
    return {
        ...
        children: [
            ...
            { type: "page", name: t("character"), url: `${preUrl}/ink/character`, icon: <User /> },
            {
                ...
                icon: <BookOpenText />,
                defaultOpen: true,
                children: [{ type: "page", name: "Knots", url: `${preUrl}/ink/label` }],
            },
            { type: "page", name: "Variables", url: `${preUrl}/ink/variables` },
            { type: "page", name: "Markup language (to add text style)", url: `${preUrl}/ink/markup` },
            { type: "page", name: "Input prompt", url: `${preUrl}/ink/input` },
            { type: "page", name: "Canvas", url: `${preUrl}/ink/canvas` },
            { type: "page", name: "Sounds and Music", url: `${preUrl}/ink/sound` },
            ...
            { type: "page", name: "Translating", url: `${preUrl}/ink/translate` },
