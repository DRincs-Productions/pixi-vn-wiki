...
On ink you have less control than in Javascript/Typescript over how and when to load assets. On **_ink_**, pixi-vn provides a single function that [load assets before a label starts](/start/assets-management#load-assets-before-a-label-starts).
