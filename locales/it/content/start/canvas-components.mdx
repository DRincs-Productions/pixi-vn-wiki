...
`@canvasComponentDecorator` è un decorator che salva il componente canvas nella memoria. Ha un parametro facoltativo che è l'id del componente canvas (deve essere univoco). Se non si passa l'id, verrà utilizzato come id il nome della classe. ( [Come abilitare i decorator in TypeScript?](/start/getting-started#how-enable-the-decorators-in-typescript) )
