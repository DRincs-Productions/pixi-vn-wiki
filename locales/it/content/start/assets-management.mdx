...
Per fare ciò, è necessario utilizzare la funzione `Assets.load` e attendere che termini (con `wait`) all'avvio del progetto. You can learn more about the `Assets.load` function [here](https://pixijs.com/8.x/guides/components/assets).
