...
È possibile caricare risorse all'avvio del progetto prima che il giocatore possa interagire con il progetto, ad esempio durante la schermata di caricamento iniziale. It is suggested to use this procedure only for assets used in the main page or for assets used frequently, and not to exceed 100MB.
