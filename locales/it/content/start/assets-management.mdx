...
It is possible to load assets as project starts in the background, giving the player the ability to interact with the project while it loads. Si consiglia di non superare i 2GB.
