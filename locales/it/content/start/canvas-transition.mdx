...
This transition has been created with the [`FadeAlphaTicker`](/start/canvas-animations-effects#fade).
...
- `props` (Optional): The properties of the effect. It corresponds to the props of the [Fade effect](/start/canvas-animations-effects#fade).
...
This transition has been created with the [`MoveTicker`](/start/canvas-animations-effects#move).
...
- `image` (Optional): The image to show. If you don't provide the URL, then the alias is used as the URL. It can be:
  ...
  - a `{ value: string[], options: ImageContainerOptions }`, where `value` is the array of URL/paths and `options` is the the options of the [ImageContainer](/start/canvas-images).
  - a [canvas component](/start/canvas-components).
- `props` (Optional): The properties of the effect. It combines the properties of the [Move effect](/start/canvas-animations-effects#move) with following properties:
