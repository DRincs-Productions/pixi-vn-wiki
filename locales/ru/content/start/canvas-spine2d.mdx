...
В настоящее время этот функционал недоступен в Pixi'VN, но мы планируем его реализовать. You can follow the development and show your interest in the following thread [discussion#284](https://github.com/DRincs-Productions/pixi-vn/discussions/284).
</Callout>
