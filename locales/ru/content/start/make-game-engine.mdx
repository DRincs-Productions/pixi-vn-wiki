...
Первый шаг - создание нового проекта. Вы можете найти больше информации о том, как создать новый проект на основе шаблона [здесь](/start/getting-started#project-initialization). The "Game Engine" template is a simple project that contains the basic structure of a game engine. By default, it exports the basic functionality of pixi-vn while removing anything unused from the package.
