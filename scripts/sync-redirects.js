...
const netlifyRedirects = redirects
    ...
    .join("");
fs.writeFileSync(netlifyPath, `${staticPart} — generated by scripts/sync-redirects.js from redirects.json${netlifyRedirects}\n`);
...
console.log(`Synced ${redirects.length} redirects to firebase.json, vercel.json, netlify.toml, and _redirects`);
