...
Как более подробно объясняется [здесь](/start/translate), Pixi'VN дает возможность переводить игровой текст с помощью библиотеки, такой как [i18next](https://www.i18next.com/). Также в **_ink_ + интеграции Pixi'VN** вы можете использовать библиотеку для перевода текста **_ink_**.
