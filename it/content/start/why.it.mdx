...
For a quick start, various [project templates](/start/getting-started#project-initialization) are available. Less experienced developers can use these templates without much knowledge of JavaScript/TypeScript.
